...
//            logger.error("Failed to set post cache: {}", e.getMessage(), e);
//        } finally {
//            if (null != jedis) {
...
//    }
//
//    public Long GetPostIdViaCache(String userId) {
...
//            return postDTO;
//        } catch (JsonMappingException e) {
//            logger.error("Failed to get post via cache: {}", e.getMessage(), e);
//
//        } catch (JsonProcessingException e) {
//            logger.error("Failed to get post via cache: {}", e.getMessage(), e);
//
