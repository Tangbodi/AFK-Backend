...
public class TrendingPostService {
    ...
    @Async("MultiExecutor")
    @Transactional
    public void SaveTrendingPost(UsersVerificationToken usersVerificationToken){
        logger.info("Saving trending post");
        try{
            TrendingPost trendingPost = new TrendingPost();
            trendingPost.setId(usersVerificationToken.getId());
            trendingPost.setMentionOn(true);
            trendingPost.setCreatedAt(usersVerificationToken.getModifiedAt());
            trendingPost.setModifiedAt(usersVerificationToken.getModifiedAt());
