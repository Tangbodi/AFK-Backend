...
public interface MessageRepository extends JpaRepository<Message,Long> {
    ...
    @Query(value = "SELECT m.message_id, m.comment_reply_id AS object_id, m.from_uid, ui.username AS from_username, ifnull(ui.avatar_url, '') AS from_avatar_url,  m.to_uid, m.content, ifnull(m.type_id, '') AS type_id, ui.created_at \n" +
