...
public class UpdateGameSaveController {
    ...
    public ResponseEntity UpdateSavedGame() throws IOException {
        ...
        Set<String> objectIds = redisLikeSaveService.GetAllSetMembers(SAVED_GAME);
        if (objectIds.isEmpty()) {
            ...
            for (String objectId : objectIds) {
                ...
                redisLikeSaveService.DeleteMember(SAVED_GAME + ":::" + objectId, userId.toString());
                if (redisLikeSaveService.NumOfMembers(objectId) == 0) {
                    redisLikeSaveService.RemoveHashSet(SAVED_GAME, objectId);
